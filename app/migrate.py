...
COLUMNS: list[tuple[str, str, str]] = [
    ...
    # ไบต์ของรูปที่เจ้าของร้านอัปโหลด — ย้ายมาจากดิสก์เพราะโฮสต์ฟรีไม่มีดิสก์ถาวร
    # NULL ได้ เพราะรูปตัวอย่างที่มากับโค้ดไม่ต้องเก็บไบต์ (อ่านจาก web/photos/)
    ("shop_images", "data", "BYTEA"),
    # รูปโปรไฟล์ช่าง — เก็บไบต์ในฐานข้อมูลเหมือนรูปร้าน
    ("staff", "photo_name", "VARCHAR(120)"),
    ("staff", "photo", "BYTEA"),
