...
const Auth = {
  ...
  clear() {
    ...
    // **ต้องล้างร้านโปรดด้วยทุกครั้ง**
    // ------------------------------------------------------------------
    // นี่คือต้นตอของบัคที่ผู้ใช้จริงเจอ: ออกจากระบบแล้วมีคนอื่นมาล็อกอินต่อ
    // ในเครื่องเดียวกัน เขาจะเห็นร้านโปรดของคนก่อนหน้าติดมาด้วย
    //
    // ตอนนี้ร้านโปรดตัวจริงอยู่ที่เซิร์ฟเวอร์แล้ว ของในเครื่องเป็นแค่แคช
    // จึงทิ้งได้ทันทีโดยไม่มีอะไรหาย — พอล็อกอินใหม่ก็ดึงของบัญชีนั้นมาแทน
    localStorage.removeItem("bookvice_favorites");
  },
  get isLoggedIn() {
    return !!this.token;
  },
