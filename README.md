...
ระบบนี้มี **83 เส้นทางภายใต้ `/api`** ไม่ใช่แค่ 10 เส้นตามตัวอย่าง เพราะทำเป็นระบบจองคิวที่ใช้งานได้จริง
...
นอกจาก 10 ข้อนี้ ยังมีเอนด์พอยต์ของระบบจริงอีก 73 เส้น รวมทั้งหมด **83 เส้น**
